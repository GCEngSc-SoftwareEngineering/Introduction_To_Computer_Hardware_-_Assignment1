...
// programs.
	private static Framework_Ptr _PGM_CLIBConcurrentServerIO = null;
...
// public.
	...
	public Framework_Ptr pgm_get_CLIBConcurrentServerIO()
	{
...
//private.
	...
	{
		Framework_Ptr _PGM_CLIBConcurrentServerIO = LIBSERVERIOCONCURRNECY_API.generate_Program();
		try {
		...
		try {
			stat_PGM_get_CLIBConcurrentServerIO().initalise(stat_PGM_get_CLIBConcurrentServerIO());
		} 
		catch (NullPointerException e) {
	...
	private static Framework_Ptr stat_PGM_get_CLIBConcurrentServerIO()
	{
